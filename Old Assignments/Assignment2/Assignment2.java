...
public class Assignment2_Start_F24 {
    ...
    /**
     * The main method will run sorting algorithms on specified array sizes
     * and then compare linear search performance vs. sort + binary search
     * using a large random dataset.
     *
     * The main method includes two parts:
     * 1. Part 1: Runs various sorting algorithms on different array sizes
     * and compares their performance.
     * 2. Part 2: Compares the performance of linear search vs. a sort followed by a binary search.
     *
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < largeArray.length; i++) {
            largeArray[i] = rand.nextInt(1000000) + 1;
        }
        ...
        boolean result = linearSearch(largeArray, value);
        long end = System.currentTimeMillis();
        long linearSearchTime = end - start;

        System.out.println("Linear search completed in: " + result + " ms");
        ...
        start = System.currentTimeMillis();
        binarySearch(sortedArray, value);  // No need to store the result if not used
        end = System.currentTimeMillis();
        ...
        System.out.println("Total time for Sort and Binary search: " + totalSortBinaryTime + " ms");

        long linearSearchesRequired = totalSortBinaryTime / linearSearchTime;
        System.out.println("Number of linear searches required: " + linearSearchesRequired);

    }


    /**
     * This method tests a sorting algorithm by running it multiple times,
     * measuring execution time, counting comparisons, and validating the result.
     *
    ...
    // Part 2, these were readily available in modules
    public static boolean linearSearch(int[] array, int searchItem) {
        for (int item : array) {
            if (array[item] == searchItem) {
                return true;
            }
        }
        return false;
    ...
    public static int binarySearch(int[] array, int value) {
        ...
        while (low <= high) {
            ...
            if (array[middle] == value)
                ...
                low = middle + 1; /* Look right */
            else
                high = middle - 1; /* Look left */
        }
        return -1; /* End of search - not found */
    }
